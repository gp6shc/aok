...
if  ( ! function_exists( 'thumbs_rating_getlink' ) ):
	...
	function thumbs_rating_getlink($post_ID = '', $type_of_vote = '')
	{
		...
		$link_up = '<span id="thumbup"class="thumbs-rating-up'. ( (isset($thumbs_rating_up_count) && intval($thumbs_rating_up_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 1, this);" data-text="' . ' +"><p class="thumbvote">' . $thumbs_rating_up_count . '</p><i class="fa fa-thumbs-up"></i></span>';
