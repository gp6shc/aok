...
function default_theme_layouts(){
    $args = array(
        array(
            'id' => 'left_column',
            'name' => 'Left Column',
            'style' => get_template_directory_uri()."/layouts/left-column.css",
            'image' => get_template_directory_uri()."/layouts/left-column.jpg"),
        array(
            'id' => 'left_column_grid',
            'name' => 'Left Column w/ Grid',
            'style' => get_template_directory_uri()."/layouts/left-column-grid.css",
            'image' => get_template_directory_uri()."/layouts/left-column-grid.jpg"),
        array(
            'id' => 'right_column',
            'name' => 'Right Column',
            'style' => get_template_directory_uri()."/layouts/right-column.css",
            'image' => get_template_directory_uri()."/layouts/right-column.jpg"),
        array(
            'id' => 'right_column_grid',
            'name' => 'Right Column w/ Grid',
            'style' => get_template_directory_uri()."/layouts/right-column-grid.css",
            'image' => get_template_directory_uri()."/layouts/right-column-grid.jpg")
    );
