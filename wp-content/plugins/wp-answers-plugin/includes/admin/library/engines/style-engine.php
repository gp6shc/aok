...
function default_theme_styles(){
    $args = array(
        array(
            'id' => 'light',
            'name' => 'Light',
            'style' => get_template_directory_uri()."/library/styles/light.css",
            'image' => get_template_directory_uri()."/library/styles/light.jpg"),
        array(
            'id' => 'dark',
            'name' => 'Dark',
            'style' => get_template_directory_uri()."/library/styles/dark.css",
            'image' => get_template_directory_uri()."/library/styles/dark.jpg")
    );
